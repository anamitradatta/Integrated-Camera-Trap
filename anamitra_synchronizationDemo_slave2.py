...
def on_connect(client, userdata, flags, rc):
	...
	if(os.path.isdir('/home/pi/Desktop/synchTestPhotos_Slave2') == False):
            print "Make Sure there's a SynchTestPhotos_Slave2 folder"
...
def on_message(client, userdata, msg):
	...
	print "Taking Camera 2 Photo" + str(photoNum)
        path = '/home/pi/Desktop/synchTestPhotos_Slave2/'
        photoName = 'synchPhotoCam2_' + str(photoNum) + '.jpg'
	...
	camera.resolution=(3280,2464)
        ...
        pathMaster = '/home/pi/Desktop/synchTestPhotos/'
        ftp.cwd(pathMaster)
